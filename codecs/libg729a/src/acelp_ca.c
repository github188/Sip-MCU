...
static void cor_h(
     ...
     GFLOAT *rr          /* (o) :Correlations of H[]         */
);
static int d4i40_17_fast(/*(o) : Index of pulses positions.               */
  GFLOAT dn[],           /* (i) : Correlations between h[] and Xn[].       */
  GFLOAT *rr,            /* (i) : Correlations of impulse response h[].    */
  GFLOAT h[],            /* (i) : Impulse response of filters.             */
  GFLOAT cod[],          /* (o) : Selected algebraic codeword.             */
  GFLOAT y[],            /* (o) : Filtered algebraic codeword.             */
...
{
  GFLOAT *rri0i0, *rri1i1, *rri2i2, *rri3i3, *rri4i4;
  GFLOAT *rri0i1, *rri0i2, *rri0i3, *rri0i4;
  GFLOAT *rri1i2, *rri1i3, *rri1i4;
  GFLOAT *rri2i3, *rri2i4;

  GFLOAT *p0, *p1, *p2, *p3, *p4;

  GFLOAT *ptr_hd, *ptr_hf, *ptr_h1, *ptr_h2;
  GFLOAT cor;
...
)
{
  ...
  GFLOAT psk, ps=0, ps0, ps1, ps2, sq, sq2;
  GFLOAT alpk, alp, max;
  GFLOAT s, alp0, alp1, alp2;
  GFLOAT *p0, *p1, *p2, *p3, *p4;

  GFLOAT sign_dn[L_SUBFR], sign_dn_inv[L_SUBFR], *psign;
  GFLOAT tmp_vect[NB_POS];
  ...
  GFLOAT  *ptr_rri0i3_i4;
  GFLOAT  *ptr_rri1i3_i4;
  GFLOAT  *ptr_rri2i3_i4;
  GFLOAT  *ptr_rri3i3_i4;
