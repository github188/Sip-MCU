...
const GFLOAT hamwindow[L_WINDOW] = {        /* hamming-cosine window */
(F)0.08000000,
(F)0.08005703,
(F)0.08022812,
(F)0.08051321,
...
/*-----------------------------------------------------*
 ...
 | Table of g729_lag_window for autocorrelation.            |

 | Bandwidth expansion = 60 Hz                         |

 -----------------------------------------------------*/

/* lag window for correlations */
/*
const GFLOAT lwindow[MP1] = {
WNC,
(F)0.99889028,
(F)0.99556851,
(F)0.99005681,
...
const GFLOAT grid[GRID_POINTS+1] = { /* grid for evaluating  Chebychev polynomials */
(F)0.9997559,
(F)0.9980267,
(F)0.9921147,
(F)0.9822872,
...
const GFLOAT inter_3l[FIR_SIZE_SYN] = {
(F)0.898517,
(F)0.769271,
(F)0.448635,
(F)0.095915,
...
const GFLOAT pred[4] = {               /* MA prediction coeff */
(F)0.68,
(F)0.58,
(F)0.34,
(F)0.19
...
const GFLOAT thr1[NCODE1-NCAN1] = {
(F)0.659681,
(F)0.755274,
(F)1.207205,
(F)1.987740
...
const GFLOAT thr2[NCODE2-NCAN2] = {
(F)0.429912,
(F)0.494045,
(F)0.618737,
(F)0.650676,
...
const GFLOAT b100[3] = {(F)0.93980581E+00, (F)-0.18795834E+01,  (F)0.93980581E+00};
const GFLOAT a100[3] = {(F)1.00000000E+00,  (F)0.19330735E+01, (F)-0.93589199E+00};

/* filter coefficients (fc = 140 Hz)  */

const GFLOAT b140[3] = {(F)0.92727435E+00, (F)-0.18544941E+01, (F)0.92727435E+00};
const GFLOAT a140[3] = {(F)1.00000000E+00, (F)0.19059465E+01, (F)-0.91140240E+00};
...
const GFLOAT past_qua_en_reset[4] = {
...
const GFLOAT lsp_reset[M] = { (F)0.9595,  (F)0.8413,  (F)0.6549,  (F)0.4154,  (F)0.1423,
							  (F)-0.1423, (F)-0.4154, (F)-0.6549, (F)-0.8413, (F)-0.9595};



const GFLOAT freq_prev_reset[M] = {  /* previous LSP vector(init) */
