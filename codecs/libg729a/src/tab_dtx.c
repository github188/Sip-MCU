...
const GFLOAT fact[NB_GAIN+1] =
        {(F)0.003125, (F)0.00078125, (F)0.000390625};
const GFLOAT tab_Sidgain[32] = {
...
const int PtrTab_1[32] = {96,52,20,54,86,114,82,68,36,121,48,92,18,120,
                         94,124,50,125,4,100,28,76,12,117,81,22,90,116,
                         127,21,108,66};
const int PtrTab_2[2][16]= {{31,21,9,3,10,2,19,26,4,3,11,29,15,27,21,12},
                           {16,1,0,0,8,25,22,20,19,23,20,31,4,31,20,31}};


const GFLOAT noise_fg_sum[MODE][M]=
{
...
const GFLOAT noise_fg_sum_inv[MODE][M]=
{
...
const GFLOAT Mp[MODE]={(F)0.065942075f, (F)0.12644604f};
