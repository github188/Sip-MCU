 ...
 */
void corr_xy2(
 GFLOAT xn[],            /* input : target vector x[0:l_subfr] */
 GFLOAT y1[],            /* input : filtered adaptive codebook vector */
 GFLOAT y2[],            /* input : filtered 1st codebook innovation */
 GFLOAT g_coeff[]        /* output: <y2,y2> , -2<xn,y2> , and 2<y1,y2>*/
)
{
   GFLOAT y2y2, xny2, y1y2;
   int i;
...
void cor_h_x(
     ...
     GFLOAT d[]         /* (o) :Correlations between h[] and x[] */
)
{
   int i, j;
   GFLOAT  s;
