...
typedef enum _LinphoneCallState{
	...
	LinphoneCallInConferencing,/** In Conferencing*/
	LinphoneCallStreamsRunning, /**<The media streams are established and running*/
	LinphoneCallVideoRecording,/** In Video Recording*/
...
/**Call state notification callback prototype*/
typedef void (*LinphoneCallStateCb)(struct _LinphoneCore *lc, LinphoneCall *call, LinphoneCallState cstate, const char *message, int code);
/** @ingroup Proxies
 * Registration state notification callback prototype
 * */
typedef void (*LinphoneRegistrationStateCb)(struct _LinphoneCore *lc, LinphoneProxyConfig *cfg, LinphoneRegistrationState cstate, const char *message,int code);
/** Callback prototype */
