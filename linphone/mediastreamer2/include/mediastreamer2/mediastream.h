...
void audio_stream_set_video_recorder(AudioStream *st, MSFilter *f);
...
void video_stream_enable_conference_mode(VideoStream *s, bool_t yesno);

void video_stream_set_video_recorder(AudioStream *st, MSFilter *f);
