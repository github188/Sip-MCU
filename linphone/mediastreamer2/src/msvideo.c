...
int ms_yuv_buf_init_from_mblk(YuvBuf *buf, mblk_t *m){
	...
	if (size==(MS_VIDEO_SIZE_QCIF_W*MS_VIDEO_SIZE_QCIF_H*3)/2){
	...
	}else if(size==(MS_VIDEO_SIZE_368P_W*MS_VIDEO_SIZE_368P_H*3)/2) {
		w=MS_VIDEO_SIZE_368P_W;
		h=MS_VIDEO_SIZE_368P_H;
	}else if(size==(MS_VIDEO_SIZE_WVGA_W*MS_VIDEO_SIZE_WVGA_H*3)/2) {
		w=MS_VIDEO_SIZE_WVGA_W;
		h=MS_VIDEO_SIZE_WVGA_H;
	}else if(size==(MS_VIDEO_SIZE_W272P_W*MS_VIDEO_SIZE_W272P_H*3)/2) {
		w=MS_VIDEO_SIZE_W272P_W;
		h=MS_VIDEO_SIZE_W272P_H;
	}else if(size==(MS_VIDEO_SIZE_W176P_W*MS_VIDEO_SIZE_W176P_H*3)/2) {
		w=MS_VIDEO_SIZE_W176P_W;
		h=MS_VIDEO_SIZE_W176P_H;
	}else if(size==(MS_VIDEO_SIZE_192P_W*MS_VIDEO_SIZE_192P_H*3)/2) {
		w=MS_VIDEO_SIZE_192P_W;
		h=MS_VIDEO_SIZE_192P_H;
	}else if(size==(MS_VIDEO_SIZE_W144P_W*MS_VIDEO_SIZE_W144P_H*3)/2) {
		w=MS_VIDEO_SIZE_W144P_W;
		h=MS_VIDEO_SIZE_W144P_H;
	}else if(size==(MS_VIDEO_SIZE_SQQVGA_W*MS_VIDEO_SIZE_SQQVGA_H*3)/2) {
		w=MS_VIDEO_SIZE_SQQVGA_W;
		h=MS_VIDEO_SIZE_SQQVGA_H;
	}else if(size==(MS_VIDEO_SIZE_S480P_W*MS_VIDEO_SIZE_S480P_H*3)/2) {
		w=MS_VIDEO_SIZE_S480P_W;
		h=MS_VIDEO_SIZE_S480P_H;
	}else if(size==(MS_VIDEO_SIZE_920P_W*MS_VIDEO_SIZE_920P_H*3)/2) {
		w=MS_VIDEO_SIZE_920P_W;
		h=MS_VIDEO_SIZE_920P_H;
	}else if(size==(MS_VIDEO_SIZE_1200P_W*MS_VIDEO_SIZE_1200P_H*3)/2) {
		w=MS_VIDEO_SIZE_1200P_W;
		h=MS_VIDEO_SIZE_1200P_H;
	}else if(size==(MS_VIDEO_SIZE_592P_W*MS_VIDEO_SIZE_592P_H*3)/2) {
		w=MS_VIDEO_SIZE_592P_W;
		h=MS_VIDEO_SIZE_592P_H;
	}else if(size==(MS_VIDEO_SIZE_IPHONE_144P_W*MS_VIDEO_SIZE_IPHONE_144P_H*3)/2) {
		w=MS_VIDEO_SIZE_IPHONE_144P_W;
		h=MS_VIDEO_SIZE_IPHONE_144P_H;
	}else if(size==(MS_VIDEO_SIZE_IPHONE_360P_W*MS_VIDEO_SIZE_IPHONE_360P_H*3)/2) {
		w=MS_VIDEO_SIZE_IPHONE_360P_W;
		h=MS_VIDEO_SIZE_IPHONE_360P_H;
	}else if(size==(MS_VIDEO_SIZE_W352P_W*MS_VIDEO_SIZE_W352P_H*3)/2) {
		w=MS_VIDEO_SIZE_W352P_W;
		h=MS_VIDEO_SIZE_W352P_H;
	}else if(size==(MS_VIDEO_SIZE_W192P_W*MS_VIDEO_SIZE_W192P_H*3)/2) {
		w=MS_VIDEO_SIZE_W192P_W;
		h=MS_VIDEO_SIZE_W192P_H;
	}else if(size==(MS_VIDEO_SIZE_WXGA900P_W*MS_VIDEO_SIZE_WXGA900P_H*3)/2) {
		w=MS_VIDEO_SIZE_WXGA900P_W;
		h=MS_VIDEO_SIZE_WXGA900P_H;
	}else if(size==(MS_VIDEO_SIZE_WXGA800P_W*MS_VIDEO_SIZE_WXGA800P_H*3)/2) {
		w=MS_VIDEO_SIZE_WXGA800P_W;
		h=MS_VIDEO_SIZE_WXGA800P_H;
	}else if(size==(MS_VIDEO_SIZE_WXGA1366P_W*MS_VIDEO_SIZE_WXGA1366P_H*3)/2){
		w=MS_VIDEO_SIZE_WXGA1366P_W;
		h=MS_VIDEO_SIZE_WXGA1366P_H;
	}else if(size==(MS_VIDEO_SIZE_960P_W*MS_VIDEO_SIZE_960P_H*3)/2){
		w=MS_VIDEO_SIZE_960P_W;
		h=MS_VIDEO_SIZE_960P_H;
	}else if(size==(MS_VIDEO_SIZE_W768_W*MS_VIDEO_SIZE_W768_H*3)/2){
		w=MS_VIDEO_SIZE_W768_W;
		h=MS_VIDEO_SIZE_W768_H;
	}else if(size==(720*480*3)/2){
		w=720;
		h=480;
	}else if(size==(720*576*3)/2){
		w=720;
		h=576;
		...
		w=320;
		h=200;
	}else if (size==(176*112*3)/2){/*format used by gTalk */
		w=176;
		h=112;
	}else if (size==(176*120*3)/2){/*format used by gTalk */
		w=176;
		h=120;
	}else if (size==(352*240*3)/2){/*format used by gTalk */
		w=352;
		h=240;
	}else{
